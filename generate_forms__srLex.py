...
class PatternPredictorAndGenerator:
    ...
    def __init__(self):
        ...
        self.Ncm_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Ncm.sav", "rb"))
        self.Npm_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Npm.sav", "rb"))
        self.Ncf_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Ncf.sav", "rb"))
        self.Npf_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Npf.sav", "rb"))
        self.Ncn_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Ncn.sav", "rb"))
        self.Npn_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Npn.sav", "rb"))
        self.Vm_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Vm.sav", "rb"))
        self.Ag_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Ag.sav", "rb"))
        self.Ap_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Ap.sav", "rb"))
        self.As_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_As.sav", "rb"))
        self.Rg_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Rg.sav", "rb"))
        self.Rr_model = pickle.load(open("./srLex_models/model_srLex_LogisticRegression_Rr.sav", "rb"))

        self.list_of_endings_for_Ncm = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Ncm_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Npm = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Npm_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Ncf = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Ncf_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Npf = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Npf_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Ncn = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Ncn_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Npn = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Npn_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Vm = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Vm_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Ag = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Ag_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Ap = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Ap_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_As = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_As_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Rg = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Rg_endings.tsv", "r", encoding="UTF-8").readlines()]
        self.list_of_endings_for_Rr = [line.strip("\n").split("\t")[0] for line in open("./ending_parts/srLex_Rr_endings.tsv", "r", encoding="UTF-8").readlines()]
        ...
        for line in open("./patterns/srLex_morphological_patterns.tsv", "r", encoding="UTF-8").readlines()[1:]:  # SKIP HEADER
